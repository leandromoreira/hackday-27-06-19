...
To update this file, create a file named tmp.h with the desired libraries content:

  #include "libavformat/avformat.h"

Then run:

  gcc -E -I /opt/ffmpeg/include tmp.h | sed '/^#/ d' | sed 's/\(\^\)/(*)/' > /lua/src/ffmpeg.h

The ffmpeg.h will be available at the src folder.
